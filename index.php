...
<div class="container"> 
  <!-- Header -->
  <header class="header">
    <h4 class="logo">CryptoConnect</h4>
  </header>
  <!-- Hero Section -->
  <section class="intro">
    <div class="column"> <img src="images/logo.jpg" alt="" class="profile"> </div>
    <div class="column">
      <p>CryptoConnect enables instant non-verification exchange  of cryptocurrencies using PayPal</p>
    </div>
  </section>
  <!-- Stats Gallery Section -->
  <div class="gallery">
    <div class="thumbnail"> <a href="#"><img src="images/btc.png" alt="" width="100"/></a>
      <h4>Bitcoin (BTC)</h4>
      <p class="tag">
      	<?php
  ...
  <!-- Copyrights Section -->
  <div class="copyright"><strong>CryptoConnect</strong> - &copy;2017</div>
</div>
<!-- Main Container Ends -->
</body>
</html>
